...
class ChosenOneGame(bs.TeamGameActivity):
    ...
    def getDescription(cls,sessionType):
        return ('Be the cursed one for a length of time to win.\n'
    ...
    def getSettings(cls,sessionType):
        return [("Chosen One Time",{'minValue':10,'default':30,'increment':10}),
                ("Cursed One Gets Gloves",{'default':True}),
                ("Cursed One Gets Shield",{'default':False}),
            ...
            if player is None or not player.exists():
                ...
                if player.actor is not None:
                    ...
                    if player.actor.node.exists():
                        if self.settings['Cursed One Gets Shield']: player.actor.handleMessage(bs.PowerupMessage('shield'))
                        if self.settings['Cursed One Gets Gloves']: player.actor.handleMessage(bs.PowerupMessage('punch'))
                        player.actor.curseTime = -1
                        player.actor.curse()
